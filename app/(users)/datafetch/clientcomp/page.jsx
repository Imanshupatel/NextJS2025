...
const DataFetchClient = () => {
    ...
    if (!userName) {
        return (
            <div className="min-h-[93vh] bg-gradient-to-black flex items-center justify-center p-4">
    ...
    return (
        <>
            <div className="min-h-[93vh] bg-gradient-black flex items-center justify-center p-4">
